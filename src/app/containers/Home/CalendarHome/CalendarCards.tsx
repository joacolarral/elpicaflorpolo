...
const CalendarCards: React.FC<CalendarCardsProps> = ({
  ...
  const cards = [
    { season: SEASON.AUTUMN, defaultImage: Autumn, hoverImage: AutumnHover },
    { season: SEASON.SPRING, defaultImage: Spring, hoverImage: SpringHover },
    { season: SEASON.SUMMER, defaultImage: Summer, hoverImage: SummerHover },
  ];
